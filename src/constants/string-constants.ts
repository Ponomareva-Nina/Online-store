...
export const ORDER_PLACEHOLDER_FIRSTNAME = 'First name';
export const ORDER_PLACEHOLDER_LASTNAME = 'Last name';
export const ORDER_PLACEHOLDER_ADDRESS = 'Delivery address';
export const ORDER_PLACEHOLDER_PHONE = 'Phone number';
export const ORDER_PLACEHOLDER_MAIL = 'Email';
export const ORDER_PLACEHOLDER_CARD = 'Card number';
