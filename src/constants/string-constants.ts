...
export const INPUT_TYPE_MAIL_PATTERN = '[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,6}$';
...
export const LOCAL_STORAGE_TOTALSUM = 'totalSum';
export const LOCAL_STORAGE_PRODUCTSQUANTITY = 'productsQuantity';
